...
class Intrinsics(FrozenClass):
    ...
    def compute_view_angle(focal_length, width, height):
        ...
        angle_of_view = 2 * math.degrees(math.atan((min_extend / float(2.0 * focal_length))))
    ...
    def get_view_angle(self):
        ...
        angle_of_view = Intrinsics.compute_view_angle(focal_length, self.width, self.height)
        return angle_of_view
    ...
    def compute_intrinsic_transformation(intrinsic_1, intrinsic_2, check_result=True):
        ...
        trans_mat_2_to_1 = np.asarray([
            [
                ...
                f_x * p_y_ * s_ / (f_x_ * f_y_) - f_x * p_x_ / f_x_ - p_y_ * s / f_y_ + p_x
             ],
            [
                0,
                f_y / f_y_,
